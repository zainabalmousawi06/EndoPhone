...
Future<void> _initSounds() async {
  ...
  Future<void> _updateVolume(SoundLayer layer, double vol) async{
    setState(() => _volumes[layer.name]= vol);
    await AudioService.instance.setVolume(layer.name, vol);
  }
  ...
  Widget build(BuildContext context){
    ...
    // FIX: read active count via public getter, not private field
            ...
            children: [
              ...
              Opacity(
                ...
                child: SliderTheme(
                  ...
                  child: Slider(
                    value: volume,
                    onChanged: (v) => _updateVolume(layer, v),
                  ),
                ),
              ),
            ],
